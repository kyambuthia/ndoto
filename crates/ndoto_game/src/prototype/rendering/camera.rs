...
pub(crate) fn render_mode_spec(mode: SpatialMode) -> RenderModeSpec {
    match mode {
        SpatialMode::ThreeD => RenderModeSpec {
            ...
            clear_color: Color::srgb(0.12, 0.14, 0.18),
            ambient_color: Color::srgb(0.78, 0.84, 0.92),
            ambient_brightness: 75.0,
            fog_color: Color::srgb(0.16, 0.18, 0.22),
            fog_start: 18.0,
            fog_end: 40.0,
        ...
        SpatialMode::TwoD => RenderModeSpec {
            ...
            clear_color: Color::srgb(0.1, 0.125, 0.16),
            ambient_color: Color::srgb(0.74, 0.8, 0.88),
            ambient_brightness: 62.0,
            fog_color: Color::srgb(0.12, 0.15, 0.2),
            fog_start: 14.0,
            fog_end: 28.0,
        ...
        SpatialMode::OneD => RenderModeSpec {
            ...
            clear_color: Color::srgb(0.08, 0.1, 0.14),
            ambient_color: Color::srgb(0.7, 0.76, 0.84),
            ambient_brightness: 52.0,
            fog_color: Color::srgb(0.1, 0.13, 0.19),
            fog_start: 14.0,
            fog_end: 28.0,
            projection: Projection::Orthographic(OrthographicProjection {
                scaling_mode: ScalingMode::FixedVertical {
